...
export default function AssetCategories() {
    ...
    const [activeCategory, setActiveCategory] = useState<AssetCategoryDto | null>(null);
        ...
        <LayoutColumn span={12} mdSpan={9} mdOffset={3} className="flex pt-35">
            <div className='w-full'>
                ...
                <div className='flex w-full flex-col gap-4 sm:flex-row sm:items-center sm:justify-between'>
                    ...
                    <Button type='submit' onClick={() => setOpenModal(true)} className='w-full sm:w-70 h-10 font-bold mb-3' iconLeft={<AddSharpIcon />}>
                        Add new category
                    </Button>
