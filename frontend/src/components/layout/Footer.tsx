...
export const Footer: React.FC<FooterProps> = ({ className }) => {
  return (
    <footer
      className={twMerge(
        'fixed bottom-0 right-0 left-0 z-10 border-t border-(--color-border) bg-(--color-surface) py-4 shadow-md md:left-[25%]',
        className
      )}
    >
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div className="flex min-w-0 flex-col gap-2">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex w-fit max-w-full items-center gap-2 break-words text-sm font-medium tracking-wide text-(--color-table-text) underline-offset-4 transition-colors hover:text-(--color-primaryblue) hover:underline"
            >
            ...
            <div className="flex flex-col gap-1 text-sm text-(--color-table-text)">
              ...
              <div className="inline-flex w-fit max-w-full items-center gap-2 break-words">
