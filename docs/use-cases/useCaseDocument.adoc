...
A1: If the booking cannot be cancelled (e.g. time already started), the system notifies the user.
...
+
* The system displays a message that the request is cancelled
