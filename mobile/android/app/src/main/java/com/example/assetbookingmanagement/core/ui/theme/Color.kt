...
val BookingStatusApprovedBg = Color(0xFFC8E6C9)
val BookingStatusPendingBg = Color(0xFFFFE0B2)
val BookingStatusCancelledBg = Color(0xFFE0E0E0)
val BookingStatusRejectedBg = Color(0xFFFFCDD2)
val BookingStatusCompletedBg = Color(0xFFD7E7FF)
